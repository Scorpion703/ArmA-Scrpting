...
//	nul = [position, radius]execVM "capturePoint.sqf";
//#####################################################################################
...
"ring" setMarkerSize [_radius, _radius];
...
while{true}do{
    _cntWest = {alive _x && side _x == west && getPos _x distance getMarkerPos "flgg" <= _radius} count allUnits; 
    _cntEast = {alive _x && side _x == east && getPos _x distance getMarkerPos "flgg" <= _radius} count allUnits; 
    _cntGuer = {alive _x && side _x == resistance && getPos _x distance getMarkerPos "flgg" <= _radius} count allUnits;
